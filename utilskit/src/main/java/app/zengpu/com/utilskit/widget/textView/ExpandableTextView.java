...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (null != mButtonText && mButtonText.getVisibility() != View.VISIBLE) {
            return;
        }
    ...
    public void setText(@StringRes int textRes) {
        mRelayout = true;
        mTv.setText(textRes);
        setVisibility(textRes > 0 ? View.VISIBLE : View.GONE);
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        if (StringUtil.isEmpty(mExpandText)) {
            mExpandText = "expand";
        }
        mCollapseText = typedArray.getString(R.styleable.ExpandableTextView_collapseText);
        if (StringUtil.isEmpty(mCollapseText)) {
            mCollapseText = "collapse";
        }
    ...
    private void findViews() {
        ...
        mButtonText = (TextView) findViewById(R.id.expand_collapse);
