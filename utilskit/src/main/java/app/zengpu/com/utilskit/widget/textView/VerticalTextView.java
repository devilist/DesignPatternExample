package app.zengpu.com.utilskit.widget.textView;
...
//        }
    ...
    private ActionMenu createActionMenu() {
        ...
        if (null != mCustomActionMenuCallBack) {
            isRemoveDefaultItem = mCustomActionMenuCallBack.onCreateCustomActionMenuV(actionMenu);
        }
    ...
    private OnClickListener mMenuClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (menuItemTitle.equals(ActionMenu.DEFAULT_MENU_ITEM_TITLE_SELECT_ALL)) {
                ...
                // 自定义事件
                if (null != mCustomActionMenuCallBack) {
                    mCustomActionMenuCallBack.onCustomActionItemClickedV(menuItemTitle, mSelectedText);
                }
                hideActionMenu();
            }
        }
    ...
    public interface CustomActionMenuCallBack {
         ...
         */
        boolean onCreateCustomActionMenuV(ActionMenu menu);
         ...
         */
        void onCustomActionItemClickedV(String itemTitle, String selectedContent);
